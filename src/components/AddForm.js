...
import { addBlogs } from "../features/blgSlice";
        ...
        <div className="mb-1 flex flex-col gap-6">
          <div>
            ...
            {formik.errors.title && formik.touched.title &&
              <h1 className="mt-2 text-pink-700">{formik.errors.title}</h1>}
          ...
          <div>
            <Typography className="te" variant="h5" color="brown" >Pick The Place</Typography>
